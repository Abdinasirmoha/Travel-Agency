...
import { usePermissions } from '../context/AuthContext';
 ...
 <div>
 <h1 className="text-2xl font-bold text-blue-600 mb-1">Payments & Receipts</h1>
 <p className="text-slate-500 text-sm">Log and manage customer payments securely.</p>
 </div>
 ...
 {hasPermission('Finance', 'edit') && (
   <button onClick={() => handleOpenEdit(pay)} className="p-2 text-slate-400 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-colors">
   <Edit className="w-4 h-4" />
   </button>
 )}
 {hasPermission('Finance', 'delete') && (
   <button onClick={() => handleDelete(pay._id)} className="p-2 text-slate-400 hover:text-red-600 hover:bg-red-50 rounded-lg transition-colors">
